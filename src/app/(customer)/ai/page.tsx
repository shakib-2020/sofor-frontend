        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="/" className="text-xs font-bold bg-white/10 hover:bg-white/15 px-4 py-2.5 rounded-xl border border-white/5 text-white transition-all">
                Manual Search
              </a>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center bg-slate-100 rounded-full p-0.5 border border-slate-200">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-bold transition-all duration-200 ${interactionMode === "chat"
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-bold transition-all duration-200 ${interactionMode === "ui"
                      ? "bg-emerald-600 text-white shadow-sm shadow-emerald-600/20"
                      : "text-slate-500 hover:text-slate-700"
                    }`}
                >
